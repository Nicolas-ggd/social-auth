  ...
  return (
    <section className="bg-gray-50 dark:bg-gray-900">
      <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        {!isSend && searchParamsToken === null && !isSuccessSend && (
            ...
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              >
                <div>
                  ...
                  <button
                    onClick={submitEmailToResetPassword}
                    type="button"
              ...
              <Link
                ...
                to="/"
                className="text-sm font-light text-sky-400 hover:text-sky-700 transition duration-200 text-primary-600 hover:underline cursor-pointer"
              >
                Back to sign in.
              </Link>
            </div>
        ...
        {isSuccessSend && !isSend && searchParamsToken === null && (
          <div role="status">
            <div className="flex flex-col items-center justify-center h-screen w-screen">
          ...
          <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              >
                <div>
                  ...
                  <input
                    style={{
                      borderColor:
                        isError && newPassword?.password?.length === 0
                          ? "red"
                          : "",
                    }}
                    type="password"
                  ...
                  <input
                    style={{
                      borderColor:
                        ...
                        (isError && newPassword?.confirmPassword?.length === 0)
                          ? "red"
                          : newPassword?.confirmPassword ===
                              newPassword?.password &&
                            newPassword?.confirmPassword
              ...
              <Link
                onClick={toggleForgotPassword}
                to="/"
                className="text-sm font-light text-primary-600 hover:underline cursor-pointer"
              >
                Back to sign in.
              </Link>
            </div>
